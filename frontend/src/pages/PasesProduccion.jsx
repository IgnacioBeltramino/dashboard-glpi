...
export default function PasesProduccion() {
  ...
  return (
    <div className="pp-page">
      ...
      <style>{`.pp-page{max-width:960px;margin:0 auto}.page-header{display:flex;align-items:center;justify-content:space-between;margin-bottom:24px}.page-header-left{display:flex;align-items:center;gap:12px}.page-header-right{display:flex;align-items:center;gap:12px}.refresh-time{font-size:12px;color:var(--text-muted)}.pp-wrap{overflow-x:auto;background:var(--surface);border:1px solid var(--border);border-radius:var(--radius)}.pp-table{width:100%;border-collapse:collapse;font-size:13px}.pp-table th{text-align:left;padding:10px 14px;color:var(--text-muted);font-weight:500;font-size:11px;text-transform:uppercase;letter-spacing:.4px;border-bottom:1px solid var(--border);white-space:nowrap}.pp-table td{padding:9px 14px;border-top:1px solid var(--border);vertical-align:middle}.pp-table tbody tr{transition:background .15s}.pp-table tbody tr:hover{background:rgba(255,255,255,.03)}.pp-id{color:var(--text-muted);font-weight:600;white-space:nowrap;font-size:12px}.pp-title{font-weight:500;max-width:500px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.pp-muted{color:var(--text-muted);white-space:nowrap;font-size:12px}.pp-state{padding:48px;text-align:center;color:var(--text-muted);font-size:13px}.pp-badge{display:inline-block;padding:2px 9px;border-radius:20px;font-size:11px;font-weight:600;white-space:nowrap}.pp-badge.fin{color:#4ade80;background:rgba(74,222,128,.12);border:1px solid rgba(74,222,128,.3)}.pp-badge.pend{color:#fbbf24;background:rgba(251,191,36,.12);border:1px solid rgba(251,191,36,.3)}.pp-link{font-size:12px;color:var(--primary);white-space:nowrap;opacity:.6;transition:opacity .15s;text-decoration:none}.pp-link:hover{opacity:1}.pp-footer{display:flex;align-items:center;justify-content:space-between;margin-top:16px;flex-wrap:wrap;gap:12px}.pp-pager{display:flex;align-items:center;gap:10px}.pp-nav-btn{padding:5px 12px;border-radius:6px;border:1px solid var(--border);background:var(--surface);color:var(--text);font-size:12px;cursor:pointer;font-family:inherit;transition:background .15s}.pp-nav-btn:hover:not(:disabled){background:rgba(255,255,255,.06)}.pp-nav-btn:disabled{opacity:.35;cursor:default}.pp-page-info{font-size:12px;color:var(--text-muted);white-space:nowrap}.pp-limit{display:flex;align-items:center;gap:6px}.pp-limit-label{font-size:12px;color:var(--text-muted)}.pp-limit-btn{padding:4px 10px;border-radius:6px;border:1px solid var(--border);background:var(--surface);color:var(--text-muted);font-size:12px;cursor:pointer;font-family:inherit;transition:all .15s}.pp-limit-btn:hover{color:var(--text);background:rgba(255,255,255,.06)}.pp-limit-btn.active{color:var(--text);background:rgba(255,255,255,.1);border-color:rgba(255,255,255,.2)}`}</style>
    </div>
  )
}
